...
describe("CompactTimerWidget", () => {
  it("shows timer controls and invokes pause, expand and finish", () => {
    ...
    render(<CompactTimerWidget kind="study" title="线性代数" statusText="正在专注" seconds={65} paused={false} side="right" onSideChange={vi.fn()} onExpand={expand} onPause={pause} onResume={vi.fn()} onFinish={finish}/>);
