...
export function SleepGapDialog({ gapSeconds: gap, onResolve }: { session?: unknown; gapSeconds: number; onResolve: (action: "include" | "exclude" | "correct", correctedSeconds?: number) => Promise<void> }) {
